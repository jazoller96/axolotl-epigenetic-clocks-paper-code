...
###############################################################################
infoAllaxolotln131expmttailregenall <- infoAllaxolotln131 %>%
  dplyr::filter(Experiment %in% c("TailRegenerationShortTerm","TailRegenerationLongTerm(1RegenerationRound)",
                                  "TailRegenerationLongTerm(2RegenerationRounds)","TailRegenerationAgedControl"))
infoAllaxolotln131expmttailregenall$SpeciesLatinName <- factor(infoAllaxolotln131expmttailregenall$SpeciesLatinName)
infoAllaxolotln131expmttailregenall$SpeciesCommonName <- factor(infoAllaxolotln131expmttailregenall$SpeciesCommonName)
infoAllaxolotln131expmttailregenall$Tissue <- factor(infoAllaxolotln131expmttailregenall$Tissue)
infoAllaxolotln131expmttailregenall$Experiment <- factor(infoAllaxolotln131expmttailregenall$Experiment)
# infoACBUaxolotln131expmttailregenall <- infoAllaxolotln131expmttailregenall %>%
#   dplyr::filter(CanBeUsedForAgingStudies == "yes")
# infoACBUaxolotln131expmttailregenall$SpeciesLatinName <- factor(infoACBUaxolotln131expmttailregenall$SpeciesLatinName)
# infoACBUaxolotln131expmttailregenall$SpeciesCommonName <- factor(infoACBUaxolotln131expmttailregenall$SpeciesCommonName)
# infoACBUaxolotln131expmttailregenall$Tissue <- factor(infoACBUaxolotln131expmttailregenall$Tissue)
# infoACBUaxolotln131expmttailregenall$Experiment <- factor(infoACBUaxolotln131expmttailregenall$Experiment)
yxs.other.list <- alignDatToInfo(infoAllaxolotln131expmttailregenall,datAllSamp,"Basename","Basename")
ys.other <- yxs.other.list[[1]]
xs.other <- yxs.other.list[[2]]
rm(yxs.other.list)

###### Fitting Final Axolotl Early Life Clock to AxolotlN131ExpmtTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen'
PREDVAR="DNAmAgebasedOnAll"
RESVAR="AgeAccelbasedOnAll"
fun_VAR1="averagedMaturity.yrs"
fun_VAR2="maxAgeCaesar"
COLVAR="Experiment"#"RegenExperimentGroup"
ys.output <- saveApplyClock(in.valbeta,xs.other,ys.other,OUTVAR,output.csv,out.png,out.png.title,PREDVAR,RESVAR,fun_inv=fun_log2.inv,COLVAR=COLVAR,oma.right=22,square.axes=F)
ys.output <- base::merge(infoAllaxolotln131expmttailregenall, ys.output[, c("Basename", PREDVAR, RESVAR)],
...
###### Fitting Final Axolotl Early Life LimbTail Clock to AxolotlN131ExpmtTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen'
...
###### Fitting Final Axolotl Early Life Limb Clock to AxolotlN131ExpmtTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen'
...
###### Fitting Final Axolotl Early Life Tail Clock to AxolotlN131ExpmtTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTailRegen'
