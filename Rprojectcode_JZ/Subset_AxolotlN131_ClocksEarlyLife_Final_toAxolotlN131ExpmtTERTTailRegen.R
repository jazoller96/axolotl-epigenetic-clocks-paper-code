...
###############################################################################
infoAllaxolotln131expmtterttailregenall <- infoAllaxolotln131 %>%
  dplyr::filter(Experiment %in% c("Test_Tail_TERT_Regeneration"))
infoAllaxolotln131expmtterttailregenall$SpeciesLatinName <- factor(infoAllaxolotln131expmtterttailregenall$SpeciesLatinName)
infoAllaxolotln131expmtterttailregenall$SpeciesCommonName <- factor(infoAllaxolotln131expmtterttailregenall$SpeciesCommonName)
infoAllaxolotln131expmtterttailregenall$Tissue <- factor(infoAllaxolotln131expmtterttailregenall$Tissue)
infoAllaxolotln131expmtterttailregenall$RegenExperimentGroup <- factor(infoAllaxolotln131expmtterttailregenall$RegenExperimentGroup)
# infoACBUaxolotln131expmtterttailregenall <- infoAllaxolotln131expmtterttailregenall %>%
#   dplyr::filter(CanBeUsedForAgingStudies == "yes")
# infoACBUaxolotln131expmtterttailregenall$SpeciesLatinName <- factor(infoACBUaxolotln131expmtterttailregenall$SpeciesLatinName)
# infoACBUaxolotln131expmtterttailregenall$SpeciesCommonName <- factor(infoACBUaxolotln131expmtterttailregenall$SpeciesCommonName)
# infoACBUaxolotln131expmtterttailregenall$Tissue <- factor(infoACBUaxolotln131expmtterttailregenall$Tissue)
# infoACBUaxolotln131expmtterttailregenall$RegenExperimentGroup <- factor(infoACBUaxolotln131expmtterttailregenall$RegenExperimentGroup)
yxs.other.list <- alignDatToInfo(infoAllaxolotln131expmtterttailregenall,datAllSamp,"Basename","Basename")
ys.other <- yxs.other.list[[1]]
xs.other <- yxs.other.list[[2]]
rm(yxs.other.list)

###### Fitting Final Axolotl Early Life Clock to AxolotlN131ExpmtTERTTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen'
...
ys.output <- base::merge(infoAllaxolotln131expmtterttailregenall, ys.output[, c("Basename", PREDVAR, RESVAR)],
...
###### Fitting Final Axolotl Early Life LimbTail Clock to AxolotlN131ExpmtTERTTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen'
...
###### Fitting Final Axolotl Early Life Limb Clock to AxolotlN131ExpmtTERTTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen'
...
###### Fitting Final Axolotl Early Life Tail Clock to AxolotlN131ExpmtTERTTailRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtTERTTailRegen'
