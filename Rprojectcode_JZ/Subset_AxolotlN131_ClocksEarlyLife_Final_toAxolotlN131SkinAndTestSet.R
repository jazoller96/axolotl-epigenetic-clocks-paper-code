...
infoAllSamp <- infoAllSamp %>%
  dplyr::select(Basename,SpeciesLatinName,OriginalOrderInBatch,Age,ConfidenceInAgeEstimate,
                ...
                Experiment,AnimalID,AnimalName)
rm(infoAllSamp.csv)
...
yxs.other.list <- alignDatToInfo(infoAllaxolotln131skinandtestset,datAllSamp,"Basename","Basename")
ys.other <- yxs.other.list[[1]]
xs.other <- yxs.other.list[[2]]
rm(yxs.other.list)

###### Fitting Final Axolotl Early Life Clock to AxolotlN131SkinAndTestSet samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet'
...
ys.output <- base::merge(infoAllaxolotln131skinandtestset, ys.output[, c("Basename", PREDVAR, RESVAR)],
...
###### Fitting Final Axolotl Early Life LimbTail Clock to AxolotlN131SkinAndTestSet samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet'
...
###### Fitting Final Axolotl Early Life Limb Clock to AxolotlN131SkinAndTestSet samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet'
...
###### Fitting Final Axolotl Early Life Tail Clock to AxolotlN131SkinAndTestSet samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131SkinAndTestSet'
