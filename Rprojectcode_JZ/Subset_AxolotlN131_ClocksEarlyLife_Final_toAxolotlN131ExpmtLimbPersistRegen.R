...
###############################################################################
infoAllaxolotln131expmtlimbpersistregen <- infoAllaxolotln131 %>%
  dplyr::filter(Experiment %in% c("PersistenceOfLimbRegenerativeRejuvenation"))
infoAllaxolotln131expmtlimbpersistregen$SpeciesLatinName <- factor(infoAllaxolotln131expmtlimbpersistregen$SpeciesLatinName)
infoAllaxolotln131expmtlimbpersistregen$SpeciesCommonName <- factor(infoAllaxolotln131expmtlimbpersistregen$SpeciesCommonName)
infoAllaxolotln131expmtlimbpersistregen$Tissue <- factor(infoAllaxolotln131expmtlimbpersistregen$Tissue)
infoAllaxolotln131expmtlimbpersistregen$RegenExperimentGroup <- factor(infoAllaxolotln131expmtlimbpersistregen$RegenExperimentGroup)
# infoACBUaxolotln131expmtlimbpersistregen <- infoAllaxolotln131expmtlimbpersistregen %>%
#   dplyr::filter(CanBeUsedForAgingStudies == "yes")
# infoACBUaxolotln131expmtlimbpersistregen$SpeciesLatinName <- factor(infoACBUaxolotln131expmtlimbpersistregen$SpeciesLatinName)
# infoACBUaxolotln131expmtlimbpersistregen$SpeciesCommonName <- factor(infoACBUaxolotln131expmtlimbpersistregen$SpeciesCommonName)
# infoACBUaxolotln131expmtlimbpersistregen$Tissue <- factor(infoACBUaxolotln131expmtlimbpersistregen$Tissue)
# infoACBUaxolotln131expmtlimbpersistregen$RegenExperimentGroup <- factor(infoACBUaxolotln131expmtlimbpersistregen$RegenExperimentGroup)
yxs.other.list <- alignDatToInfo(infoAllaxolotln131expmtlimbpersistregen,datAllSamp,"Basename","Basename")
ys.other <- yxs.other.list[[1]]
xs.other <- yxs.other.list[[2]]
rm(yxs.other.list)

###### Fitting Final Axolotl Early Life Clock to AxolotlN131ExpmtLimbPersistRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen'
...
ys.output <- saveApplyClock(in.valbeta,xs.other,ys.other,OUTVAR,output.csv,out.png,out.png.title,PREDVAR,RESVAR,fun_inv=fun_log2.inv,COLVAR=COLVAR,oma.right=23,square.axes=F)
ys.output <- base::merge(infoAllaxolotln131expmtlimbpersistregen, ys.output[, c("Basename", PREDVAR, RESVAR)],
...
###### Fitting Final Axolotl Early Life LimbTail Clock to AxolotlN131ExpmtLimbPersistRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen'
...
###### Fitting Final Axolotl Early Life Limb Clock to AxolotlN131ExpmtLimbPersistRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen'
...
###### Fitting Final Axolotl Early Life Tail Clock to AxolotlN131ExpmtLimbPersistRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbPersistRegen'
