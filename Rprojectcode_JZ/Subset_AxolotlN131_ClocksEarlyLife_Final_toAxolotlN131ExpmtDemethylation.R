...
infoAllaxolotln131expmtdemethylation <- infoAllaxolotln131 %>%
  dplyr::filter(Experiment %in% c("DemethylationTreatmentCells_Clock","DemethylationTreatmentCells_Revision","DemethylationTreatmentLarva")) # "DemethylationTreatmentCells" intentionally ommitted
...
yxs.other.list <- alignDatToInfo(infoAllaxolotln131expmtdemethylation,datAllSamp,"Basename","Basename")
ys.other <- yxs.other.list[[1]]
xs.other <- yxs.other.list[[2]]
rm(yxs.other.list)

###### Fitting Final Axolotl Early Life Clock to AxolotlN131ExpmtDemethylation samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtDemethylation_PredictedValues.csv'
out.png=NULL
out.png.title=NULL
...
COLVAR="Experiment"
ys.output <- saveApplyClock(in.valbeta,xs.other,ys.other,OUTVAR,output.csv,out.png,out.png.title,PREDVAR,RESVAR,fun_inv=fun_log2.inv,COLVAR=COLVAR)
ys.output <- base::merge(infoAllaxolotln131expmtdemethylation, ys.output[, c("Basename", PREDVAR, RESVAR)],
...
###### Fitting Final Axolotl Early Life LimbTail Clock to AxolotlN131ExpmtDemethylation samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtDemethylation_PredictedValues.csv'
out.png=NULL
out.png.title=NULL
...
###### Fitting Final Axolotl Early Life Limb Clock to AxolotlN131ExpmtDemethylation samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtDemethylation_PredictedValues.csv'
out.png=NULL
out.png.title=NULL
...
###### Fitting Final Axolotl Early Life Tail Clock to AxolotlN131ExpmtDemethylation samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtDemethylation_PredictedValues.csv'
out.png=NULL
out.png.title=NULL
