...
###############################################################################
infoAllaxolotln131expmtlimbrepregen <- infoAllaxolotln131 %>%
  dplyr::filter(Experiment %in% c("RepetitiveLimbRegeneration"))
infoAllaxolotln131expmtlimbrepregen$SpeciesLatinName <- factor(infoAllaxolotln131expmtlimbrepregen$SpeciesLatinName)
infoAllaxolotln131expmtlimbrepregen$SpeciesCommonName <- factor(infoAllaxolotln131expmtlimbrepregen$SpeciesCommonName)
infoAllaxolotln131expmtlimbrepregen$Tissue <- factor(infoAllaxolotln131expmtlimbrepregen$Tissue)
infoAllaxolotln131expmtlimbrepregen$RegenExperimentGroup <- factor(infoAllaxolotln131expmtlimbrepregen$RegenExperimentGroup)
# infoACBUaxolotln131expmtlimbrepregen <- infoAllaxolotln131expmtlimbrepregen %>%
#   dplyr::filter(CanBeUsedForAgingStudies == "yes")
# infoACBUaxolotln131expmtlimbrepregen$SpeciesLatinName <- factor(infoACBUaxolotln131expmtlimbrepregen$SpeciesLatinName)
# infoACBUaxolotln131expmtlimbrepregen$SpeciesCommonName <- factor(infoACBUaxolotln131expmtlimbrepregen$SpeciesCommonName)
# infoACBUaxolotln131expmtlimbrepregen$Tissue <- factor(infoACBUaxolotln131expmtlimbrepregen$Tissue)
# infoACBUaxolotln131expmtlimbrepregen$RegenExperimentGroup <- factor(infoACBUaxolotln131expmtlimbrepregen$RegenExperimentGroup)
yxs.other.list <- alignDatToInfo(infoAllaxolotln131expmtlimbrepregen,datAllSamp,"Basename","Basename")
ys.other <- yxs.other.list[[1]]
xs.other <- yxs.other.list[[2]]
rm(yxs.other.list)

###### Fitting Final Axolotl Early Life Clock to AxolotlN131ExpmtLimbRepRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLife_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen'
...
ys.output <- base::merge(infoAllaxolotln131expmtlimbrepregen, ys.output[, c("Basename", PREDVAR, RESVAR)],
...
###### Fitting Final Axolotl Early Life LimbTail Clock to AxolotlN131ExpmtLimbRepRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimbTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen'
...
###### Fitting Final Axolotl Early Life Limb Clock to AxolotlN131ExpmtLimbRepRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeLimb_subCPGcombinationmiddlefilter_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen'
...
###### Fitting Final Axolotl Early Life Tail Clock to AxolotlN131ExpmtLimbRepRegen samples ######
OUTVAR="Age"
...
output.csv='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen_PredictedValues.csv'
out.png='SpeciesSubsetAnalyses/Subset_AxolotlN131_Clocks_Final/Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen.png'
out.png.title='Subset_AxolotlN131_ClockEarlyLifeTail_subCPGaxolotln131_basedOnAll_EpigeneticLog2Age_toAxolotlN131ExpmtLimbRepRegen'
